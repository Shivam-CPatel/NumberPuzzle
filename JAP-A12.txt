...
SET MAINCLASSSRC=src/NumMain/NumPuzzMain.java
SET MAINCLASSBIN=NumMain.NumPuzzMain
...
cd ..
"C:\Program Files\Java\jdk-18.0.2.1\bin\javadoc" -cp ".;%BINDIR%;%JAVAFXDIR%/*" --module-path "%JAVAFXDIR%" --add-modules %MODULELIST% -d %DOCDIR% -sourcepath %SRCDIR% -subpackages %DOCPACK% > %DOCOUT% 2> %DOCERR%
